<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TypeList.aspx.cs" Inherits="CNVP.Client.TypeList" %>
...
<td id="Part01" valign="top">
    ...
    <dl>
        ...
        <dd class="current"><a href="TypeList.aspx" class="jp">精品</a></dd>
...
<td id="Part02" style="display:none"></td>
...
<div id="TypeList">
    <div class="Scroller">
        ...
        <ul><li class="CarInfo">&nbsp;适用车型：</li></ul>
        <ul>
        <li>
...
<script language="javascript" type="text/javascript">
    ...
    function PageReset() {
        ...
        $('#TypeList').css('width', (width - 70) + 'px');
    ...
    function GetLocation(SelectTypeID) {
        $.ajax({ type: "GET", dataType: "HTML", url: "TypeList.aspx?Time=" + (new Date().getTime()), data: { Action: 'GetRootPath', TypeID: SelectTypeID },
            success: function (d) {
                $('.Header').empty();
    ...
    function GetProductType(TypeID) {
        ...
        $.ajax({ type: "GET", dataType: "JSON", url: "TypeList.aspx?Time=" + (new Date().getTime()), data: { Action: 'GetProductType', TypeID: TypeID },
            success: function (d) {
                if (d.RecordCount > 0) {
    ...
    function GetCarList() {
        ...
        $.ajax({ type: "GET", dataType: "JSON", url: "TypeList.aspx?Time=" + (new Date().getTime()), data: { Action: 'GetCarList' },
            success: function (d) {
                $.each(d.Rows, function (idx, item) {
    ...
    function GetProductList(TypeID, CarID) {
        $.ajax({ type: "GET", dataType: "JSON", url: "TypeList.aspx?Time=" + (new Date().getTime()), data: { Action: 'GetTypeProduct', CarID: SelectCarID, TypeID: SelectTypeID, PageSize: PageSize, PageNo: PageNo },
            success: function (d) {
