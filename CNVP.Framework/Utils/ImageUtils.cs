...
namespace CNVP.Framework.Utils
{
    ...
    public static class ImageUtils
    {
        ...
        public static void AddImageSignPic(string originalImagePath, string filename, string watermarkFilename, int watermarkStatus, int quality, int watermarkTransparency)
        {
        ...
        /// 截取固定大小
        /// </summary>
        /// <param name="oPath">原始图片</param>
        /// <param name="tPath">生成图片</param>
        /// <param name="x1"></param>
        /// <param name="x2"></param>
        /// <param name="y1"></param>
        /// <param name="y2"></param>
        public static void CreateImage(string oPath, string tPath, int x1, int x2, int y1, int y2)
        {
            ...
            using (System.Drawing.Bitmap _bitmap = new System.Drawing.Bitmap(w, h))
            {
                ...
                using (Graphics _graphic = Graphics.FromImage(_bitmap))
                {
                    ...
                    _bitmap.Save(tPath, System.Drawing.Imaging.ImageFormat.Jpeg);
                }
            }
            img.Dispose();
        }
