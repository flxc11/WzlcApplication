<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RolesEdit.aspx.cs" Inherits="CNVP.Admin.RolesEdit" %>
...
<form id="mainform" method="post" action="Roles.aspx?Action=EditRoles"></form> 
<script type="text/javascript">
    ...
    LG.loadForm(mainform, { ashxUrl: 'Roles.aspx?Time=' + (new Date().getTime()), data: { Action: 'GetRoles', RoleID: RoleID} }, f_loaded);
