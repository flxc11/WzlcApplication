<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersAdd.aspx.cs" Inherits="CNVP.Admin.UsersAdd" %>
...
<form id="mainform" method="post" action="Users.aspx?Action=AddUserInfo"></form> 
<script type="text/javascript">
    ...
    mainform.ligerForm({
        ...
        { display: "登录帐号", name: "LoginName", newline: true, labelWidth: 100, width: 220, space: 30, type: "text", validate: { required: true, username: true, minlength: 2, maxlength: 20, remote: 'Users.aspx?Action=IsExist', messages: { required: '登录帐号不能为空。', remote: '登录帐号已经存在。'} }, group: "基本信息", groupicon: "../lib/icons/32X32/communication.gif" },
        ...
        { display: "登录密码", name: "UserPass", newline: true, labelWidth: 100, width: 220, space: 30, type: "password", validate: { maxlength: 30, required: true, messages: { required: '登录密码不能为空。'}} },
        { display: "确认密码", name: "UserPass1", newline: false, labelWidth: 100, width: 220, space: 30, type: "password", validate: { maxlength: 30, required: true, equalTo: '#UserPass', messages: { required: '确认密码不能为空。', equalTo: '两次密码输入不一致。'}} },
