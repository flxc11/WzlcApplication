...
<script type="text/javascript">
    ...
    mainform.ligerForm({
        ...
        { display: "登录帐号", name: "LoginName", newline: true, labelWidth: 100, width: 220, space: 30, type: "text", validate: { required: true, username: true, minlength: 4, maxlength: 20, remote: 'Users.aspx?Action=IsExist', messages: { required: '登录帐号不能为空。', remote: '登录帐号已经存在。'} }, group: "基本信息", groupicon: "../lib/icons/32X32/communication.gif" },
