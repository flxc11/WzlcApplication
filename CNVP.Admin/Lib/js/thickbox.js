	...
	try {
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images			
			...
			imgPreloader.onload = function(){
				...
				$("#TB_window").append("<div id='TB_title' onmousedown=\"startDrag(this)\" onmouseup=\"stopDrag(this)\" onmousemove=\"drag(this)\"><div id='TB_caption'>" + caption + "</div><div id='TB_closeWindow'><a href='javascript:void();' id='TB_closeWindowButton'>关闭</a></div></div><a href='javascript:void();' id='TB_ImageOff' title='关闭'><img id='TB_Image' src='" + url + "' width='" + imageWidth + "' height='" + imageHeight + "' alt='" + caption + "'/></a><div id='TB_secondLine'>" + TB_imageCount + TB_PrevHTML + TB_NextHTML + "</div>"); 		
		...
		if(urlType=='.swf' || (url.indexOf('TB_flash') != -1)){//code to show swf 
			...
			imgPreloader.onload = function(){
				...
				$("#TB_window").append("<div id='TB_title' onmousedown=\"startDrag(this)\" onmouseup=\"stopDrag(this)\" onmousemove=\"drag(this)\"><div id='TB_caption'>"+caption+"</div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton'>关闭</a></div></div><a href='' id='TB_ImageOff' title='Close'>"+TB_showFlash(TB_WIDTH,TB_HEIGHT,urlNoQuery)+"</a><div id='TB_secondLine'>" + TB_imageCount + TB_PrevHTML + TB_NextHTML +"</div>"); 		
				$("#TB_closeWindowButton").click(TB_remove);
				if (!(TB_PrevHTML == "")) {
					function goPrev(){
						//if($(document).unclick(goPrev)){$(document).unclick(goPrev)};
		...
		if(urlType=='.wma'||urlType=='.wmv'||urlType=='.mp3'||urlType=='.mp4'||urlType=='.rm'||urlType=='.3gp'||urlType=='.rmvb'||urlType=='.avi'||urlType=='.mpg'||urlType=='.asf'||(url.indexOf('TB_media') != -1)){//code to show media 
			...
			imgPreloader.onload = function(){
				...
				$("#TB_window").append("<div id='TB_title' onmousedown=\"startDrag(this)\" onmouseup=\"stopDrag(this)\" onmousemove=\"drag(this)\"><div id='TB_caption'>"+caption+"</div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton'>关闭</a></div></div><a href='' id='TB_ImageOff' title='Close'>"+TB_showMedia(TB_WIDTH,TB_HEIGHT,urlNoQuery)+"</a><div id='TB_secondLine'>" + TB_imageCount + TB_PrevHTML + TB_NextHTML +"</div>"); 		
				$("#TB_closeWindowButton").click(TB_remove);
				if (!(TB_PrevHTML == "")) {
					function goPrev(){
						//if($(document).unclick(goPrev)){$(document).unclick(goPrev)};
