...
<body>
    ...
    <div class="LCDA_MainArea m0a">
        <div class="w734 fr">
            ...
            <div class="field" style="text-align:center; color:red; width: 100%;font-size:16px;">请同时输入姓名和身份证号码登录，若是第一次申请，请先注册再进行申请！</div>
            <div class="field">
            <span class="red">*</span>
            ...
            <div class="field" style="width:100%;height:auto; text-align:left;"><img src="Lib/images/btnsubmit1.png" onclick="checkSubmit()" style="cursor:pointer;margin-left:150px;margin-top:10px;" /><a href="AppReg.aspx"><img src="Lib/images/btnsubmit2.png" style="cursor:pointer;margin-left:10px;margin-top:10px;" /></a></div>
            </form>
                    </div>
                </div>
            </div>
