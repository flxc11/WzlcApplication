<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoresAdd.aspx.cs" Inherits="CNVP.Admin.StoresAdd" %>
...
<form id="mainform" method="post" action="Stores.aspx?Action=AddAppInfo"></form> 
<script type="text/javascript">
    ...
    //获取通讯密钥
    $.ajax({ type: "post", dataType: "json", url: "Stores.aspx?Action=GetRsaKeys&Time=" + (new Date().getTime()), success: function (d) {
        $("#AppPubKey").attr('value', d.PubKey);
        $("#AppPriKey").attr('value', d.PriKey);
    }
    });
    $("#AppPubKey,#AppPriKey").attr("readonly", "readonly");
    $("#IsLock").attr('value', '1');
