<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TypeEdit.aspx.cs" Inherits="CNVP.Admin.Appli.TypeEdit" %>
...
<form id="mainform" method="post" action="TypeList.aspx?Action=EditInfo"></form> 
<script type="text/javascript">
    ...
    mainform.ligerForm({
        ...
        fields: [
        { name: "ID", type: "hidden" },
        { display: "事情名称", name: "TypeName", newline: true, labelWidth: 100, width: 220, space: 30, type: "text", validate: { required: true, messages: { required: '事项名称不能为空' } }, group: "基本信息", groupicon: "../lib/icons/32X32/communication.gif" },
        { display: "事项说明", name: "TypeContent", newline: true, labelWidth: 100, width: 570, space: 30, type: "textarea" }],
    ...
    LG.loadForm(mainform, { ashxUrl: 'TypeList.aspx?Time=' + (new Date().getTime()), data: { Action: 'GetTypeInfo', ID: ID } }, f_loaded);
