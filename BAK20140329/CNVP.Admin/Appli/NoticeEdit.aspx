<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeEdit.aspx.cs" Inherits="CNVP.Admin.Appli.NoticeEdit" ValidateRequest="false" EnableEventValidation="false" %>
...
<div class="tab_con" style="display:block;">
    <input type="hidden" name="HidTypeID" id="HidTypeID" value="<%=CurrentID %>" />
...
<td style="padding-top:15px;padding-bottom:15px">
    <script id="editor" type="text/plain" style="width:600px;height:300px;"><%=NoticeContent %></script>
...
<script type="text/javascript">
    ...
    function f_save() {
        if ($("#NoticeTitle").val().length <= 0) {
            ...
            $("#form1").attr('action', 'NoticeEdit.aspx?Action=Edit');
            $("#form1").submit();
            return true;
        }
