...
<div id="pageloading" style="display:block;"></div> 
    <div id="topmenu" class="l-topmenu">
        ...
        <div class="l-topmenu-welcome"> 
            <span class="l-topmenu-username"></span>欢迎回来，<asp:Literal ID="LitUserName" runat="server"></asp:Literal>&nbsp;[<a href="javascript:showTB('AdminInfo.aspx',350,180,'修改密码','parent');">修改密码</a>]&nbsp;[<a href="javascript:void()" onclick="ResetSite();">站点重置</a>]&nbsp;[<a href="LoginOut.aspx">退出登录]</a>
        </div> 
    </div> 
